            ...
            <MDBCard className="card mx-auto row my-3 justify-content-center px-2">
                ...
                <MDBCol className="col-md-9 position-relative p-0">
                    <span className="position-absolute right joinBtn">
                        <MDBBtn className="btn btn-default Ripple-parent sugar py-2 px-3 rounded"  onClick={() => props.joinEvent(localStorage.getItem('user.id'),props.events.id)}>Join   <i className="mr-2 mx-auto fal fa-calendar-plus fa-lg"></i></MDBBtn>
                    </span>
