...
INSERT INTO events (event_name, start_date, end_date, event_time, event_city, event_state, event_zipcode, description, createdAt, updatedAt, GameCategoryId, UserId) 
values ('Street Hockey', '2019-07-15', '2019-07-15', '17:30:00', 'Bloomington', 'MN', 55104, 'Street hockey (also known as dek hockey, ball hockey, road hockey) is a variation of the sport of ice hockey where the game is played outdoors on foot, or with inline or roller skates using a ball or puck. ... Players determine whether to use a hockey ball, a tennis ball, or a street hockey puck. Please be there 15 min early. Bring a white and black t-shirt to help us break into teams.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '3', '1');
